...
int tugas1(bool *running)
{
    ...
    for(y = vinfo.yres - 10; y >= -720; y--){
        ...
        printName1(Amuz, 4, 50, 203, 0, y + 270);
        printName1(Aggi, 4, 41, 121, 255, y + 360);
        printName1(Bobby, 5, 98, 0, 234, y + 450); 
        printName1(Fajar, 5, 123, 31, 162, y + 540);
        printName1(Icha, 4, 183, 110, 121, y + 630);

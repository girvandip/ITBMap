...
void printChar1(char Character, int Red, int Green, int Blue, int axis, int ordinat)
{
    ...
    switch (Character) {
        case 'a':
            file = fopen("characters1/a.txt", "r");
            break;
        case 'b':
            file = fopen("characters1/b.txt", "r");
            break;
        case 'c':
            file = fopen("characters1/c.txt", "r");
            break;
        case 'd':
            file = fopen("characters1/d.txt", "r");
            break;
        case 'f':
            file = fopen("characters1/f.txt", "r");
            break;
        case 'g':
            file = fopen("characters1/g.txt", "r");
            break;
        case 'h':
            file = fopen("characters1/h.txt", "r");
            break;
        case 'i':
            file = fopen("characters1/i.txt", "r");
            break;
        case 'j':
            file = fopen("characters1/j.txt", "r");
            break;
        case 'l':
            file = fopen("characters1/l.txt", "r");
            break;
        case 'm':
            file = fopen("characters1/m.txt", "r");
            break; 
        case 'n':
            file = fopen("characters1/n.txt", "r");
            break;
        case 'o':
            file = fopen("characters1/o.txt", "r");
            break;
        case 'r':
            file = fopen("characters1/r.txt", "r");
            break;
        case 'u':
            file = fopen("characters1/u.txt", "r");
            break;    
        case 'y':
            file = fopen("characters1/y.txt", "r");
            break;
        case 'z':
            file = fopen("characters1/z.txt", "r");
            break;  
    }
